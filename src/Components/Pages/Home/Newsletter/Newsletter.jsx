...
const Newsletter = () => {
  return (
    ...
    <Container>
      <div className="bg-secondary rounded-4 overflow-hidden position-relative">
        <Row className="flex-column flex-lg-row">
          {/* Left */}
          <Col
            lg={6}
            className="d-flex flex-column justify-content-center align-items-start p-5 position-relative text-white"
            style={{ backgroundColor: "#3056D3", borderRadius: "1rem 0 0 1rem" }}
          >
          ...
          {/* Right */}
          <Col lg={6} className="p-5 bg-dark text-white">
            ...
            <Form className="d-flex flex-column flex-sm-row align-items-stretch gap-2 mb-3">
              <Form.Control
                ...
                className="flex-grow-1 bg-dark border border-secondary text-white"
                style={{ height: "50px" }}
              />
              <Button
                variant="primary"
