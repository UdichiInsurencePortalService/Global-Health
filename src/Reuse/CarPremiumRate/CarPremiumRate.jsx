...
// }) {
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-5 px-5">
//       <div className="bg-white rounded-lg shadow-md p-6 max-w-4xl w-full">
//         <h1 className="fst-italic text-2xl font-bold text-center mb-4 text-gray-800 fw-bold mb-3 text-center font-weight: 600 font-style: Italic">
//           {heading}
//         </h1>
//         <p className="text-center text-gray-600 mb-6 px-4">{para}</p>
//         <div className="overflow-x-auto ">
//           <table className="border-collapse mx-auto w-full md:w-auto flex items-center justify-center">
//             <thead>
//             <tr className="bg-warning text-black text-start">
