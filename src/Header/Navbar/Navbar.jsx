    ...
    <>
            ...
            <div className="col-lg-6 col-md-7 col-12">
              ...
              >
                ...
                <li style={{ color: "white" }}>
                  ...
                  ></i>
                  <Link
                    to="mailto:globalhealth235@gmail.com"
                    style={{ color: "white", textDecoration: "none" }}
                  >
                    ...
                    >
                      <li style={{ flex: 1, listStyle: "none" }}>
                        ...
                        <ul className="list-unstyled">
                          <li>
                            <Link to="/carinsurance" className="dropdown-item">
                              Car Insurance
                            </Link>
                          </li>
                          <li>
                            <Link
                              to="/product/life-insurance"
      ...
      >
        ...
        <ul className="contact-list">
          <li>
            <b>Muscat Office:</b> P.O. Box 556. Postal code No. 103. Muscat,
            Sultanate of Oman; Telephone: (968) 928 655 17, (968) 992 134 62
          </li>
          <li>
            <b>Mauritius Office:</b> 301, Cyber City, Ebene.
          </li>
          <li>
            <b>Toronto Office:</b> PO Box 4643, Station A Toronto, Ontario M5W
            5E3, 1-877-780-7247
          </li>
          <li>
            <b>Texas Office:</b> 1010 E. Lookout Drive Richardson TX 75082,
            800-451-0267
          </li>
          <li>
            <b>London Office:</b> 1st Floor, Dean House, 193 High St, Ponders
            End, Enfield EN3 4EA, United Kingdom
          </li>
          <li>
            <b>Paris Office:</b> 31 Rue de Châteaudun, 75009 Paris, France
          </li>
          <li>
            <b>Mumbai Office:</b> 43, Ashok Nagar, Opp Dwarka Hotel, Achole
            Road, Nallasopara, Mumbai -209
          </li>
        </ul>
      </Drawer>
      <ToastContainer />
