...
import pdf4 from "../../../../src/pdf/Global Health Icon Award.pdf";
...
const Downloads = () => {
  ...
  const pdfCards = [
    {
      id: 1,
      name: "Nomination Form For Individuals for Global Medical Icon Award",
      fileName:
        "Fill Nomination Form For Individuals for Global Medical Icon Award.pdf",
      filePath: pdf1,
    },
    {
      id: 2,
      name: "Nomination Form For Medical Equipment",
      fileName: "Medical Equipment.pdf",
      filePath: pdf2,
    },
    {
      id: 3,
      name: "Nomination Form For Hospital nomination",
    ...
    },
    {
      ...
      fileName: "Global Health Icon Award.pdf",
      filePath: pdf4,
    },
  ];
      ...
      <div className="container">
        <div className="row mb-4">
          <div className="col-12 text-center">
            <h2 className="display-5 fw-bold text-black-1 mb-3">
              Nomination Form
            </h2>
          </div>
        </div>
